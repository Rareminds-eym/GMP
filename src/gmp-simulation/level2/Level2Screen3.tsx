...
import { Lightbulb, Users, Zap, Target, Rocket, Globe, FileText, Sparkles, Upload, CheckCircle, AlertTriangle, ChevronRight, Star, Award, Flame } from 'lucide-react';
...
const Level2Screen3: React.FC = () => {
  ...
  }, [problem, technology, collaboration, creativity, speedScale, impact, file, reflection]);
            ...
            <div className="relative z-10">
              ...
              <div className={`grid ${isMobileHorizontal ? 'grid-cols-9 gap-1' : 'grid-cols-9 gap-2'}`}>
                {stages.map((stageData, index) => {
                  ...
                  const isPrevious = stageNumber < stage;
